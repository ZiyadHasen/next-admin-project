        ...
        <div className='mx-4  mt-8'>
          ...
          <div className='h-[550px] pt-2 pb-4 px-6 mb-[5rem] bg-white '>
            ...
            <div className='flex items-center gap-6 mt-4 h-[30px]:'>
              <div className='flex-1 border-b-[2px] border-[#616161]'>
            ...
            <div className='flex items-center gap-6 mt-4 h-[30px]:'>
              ...
              <div className='border-b-[2px] flex flex-1 gap-16 items-center   border-[#616161] '>
            ...
            <h1 className='bg-[#9E9E9E] my-4 text-[#616161] text-sm font-bold p-2'>
              가이드 내용
            </h1>
            {/* row four */}
            <div className='flex items-center gap-6 mt-4 h-[30px] '>
              <div className='flex flex-1 gap-10 items-center border-b-[2px] border-[#616161]'>
            ...
            <div className='flex items-center gap-6 mt-4 h-[30px] '>
              <div className='flex flex-1 gap-10 items-center border-b-[2px] border-[#616161]'>
                ...
                <input
                  type='text'
                  placeholder='https://youtu.be/D0J6Y3nom7w?si=017z5gRlWuyYQlp7'
                  className='input  focus:outline-none focus:border-0  border-gray-200  text-[#616161] text-sm h-[28px] w-full   mb-[1px] rounded-none'
                />
              </div>
            </div>
            ...
            <div className='flex items-start gap-8'>
              <div className='flex w-1/2 items-start gap-6  mt-4'>
                <div className=' flex flex-1 items-center border-b-[2px] gap-16 mt-4 h-[30px] border-gray-500'>
                  <h2 className='text-[#616161] text-sm font-bold '>
                    썸네일 *
                  </h2>
